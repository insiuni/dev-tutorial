...
import { Sparkles, BookOpen, LogOut, ShieldCheck } from 'lucide-react';
...
export function Navbar({ user, onSignOut, onNewEntry, activeModel = 'gemini-3.6-flash' }: NavbarProps) {
  return (
